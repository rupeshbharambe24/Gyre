...
![tests](https://img.shields.io/badge/tests-141%20green-brightgreen.svg)
...
The workspace is a Cargo workspace of **14 crates, 141 tests, all green** (edition
