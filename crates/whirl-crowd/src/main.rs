...
//! bottom line that neither manufactures the crowd. Run with `cargo run -p whirl-crowd`.

use whirl_crowd::{reward_with_self_bond_premium, stake_to_control, Admission, Governor};

fn main() {
    println!("Whirlpool · P4 — the crowd / incentive layer (the binding constraint)");
    println!("{}", "-".repeat(70));
