...
//! uniform client fingerprint. Run it with `cargo run -p whirl-endpoint`.

use whirl_endpoint::{naive_fingerprint, uniform_fingerprint, Identity, Ratchet};
...
fn main() {
    println!("Whirlpool · Addition 2 — endpoint hardening + data minimization");
    println!("{}", "-".repeat(68));
